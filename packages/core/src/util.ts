...
export async function checkUpdates() {
  // fetch latest bot.ts version from npm registry
  const remoteJSON: PackageJson = await fetch(
    "https://registry.npmjs.org/@ghom/bot.ts/latest",
...
export const emojiRegex =
  // biome-ignore lint/suspicious/noMisleadingCharacterClass: emoji regex intentionally uses complex Unicode ranges
